...
Se assumirmos que desejamos modelos com um R² de no mínimo 80%, iremos precisar de uma razão `(n-1)/p` superior à 5 para que o R² ajustado seja numericamente superior a zero.

![](https://noliquidificador.files.wordpress.com/2012/07/brain-explode.jpg)
