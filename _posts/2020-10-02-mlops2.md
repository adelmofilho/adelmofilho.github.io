...
Na AWS, o serviço de versionamento de código é o [`CodeCommit`](). Vamos criar um repositório conforme as instruções da [documentação oficial](https://docs.aws.amazon.com/codecommit/latest/userguide/getting-started.html).
